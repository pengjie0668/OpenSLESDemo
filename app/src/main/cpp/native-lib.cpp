...
Java_com_pengjie0668_opensles_demo_MainActivity_rdSound(JNIEnv *env, jobject instance, jstring path_) {
    const char *path = env->GetStringUTFChars(path_, 0);
    /**
     * PCM文件
     */
    inputPcmFile = fopen(path, "w");
    /**
     * PCMbuffer队列
     */
...
JNIEXPORT void JNICALL
Java_com_pengjie0668_opensles_demo_MainActivity_rdStop(JNIEnv *env, jobject instance) {
